...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <br />
                ...
                <br />
<asp:RequiredFieldValidator ID="RequiredFieldValidatorUN" runat="server" ErrorMessage="Username Required" ControlToValidate="tbUsername" ForeColor="Red" Font-Italic="true"></asp:RequiredFieldValidator>
                <br />
                <asp:Label ID="LblPassword" runat="server" Text="Password"></asp:Label>
                <br />
                <asp:TextBox ID="tbPassword" runat="server" Width="196px"></asp:TextBox>
                <br />
    <asp:RequiredFieldValidator ID="RequiredFieldValidatorPW" runat="server" ErrorMessage="Password Required" ControlToValidate="tbPassword" ForeColor="Red" Font-Italic="true"></asp:RequiredFieldValidator>
                <br />
